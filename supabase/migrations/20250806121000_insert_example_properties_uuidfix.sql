-- Migration: Insert example user, profile, and properties with images in Supabase storage (with uuid/text cast fix)
...
SELECT * FROM (
  SELECT
    '00000000-0000-0000-0000-000000000001'::uuid AS host_id,
...
WHERE NOT EXISTS (
  SELECT 1 FROM public.properties WHERE title = example_properties.title AND host_id = example_properties.host_id::uuid
);
